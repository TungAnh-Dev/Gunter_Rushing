...
public static class ParticlePool
{
    ...
    static public void Play(ParticleSystem prefab, Vector3 pos, Quaternion rotation)
    {
#if UNITY_EDITOR
        if (prefab == null)
        {
        ...
        pools[prefab.GetInstanceID()].Play(pos, rotation);
    }

    static public void Play(ParticleType particleType, Vector3 pos, Quaternion rotation)
    {
#if UNITY_EDITOR
        ...
        Play(shortcuts[particleType], pos, rotation);
    }
